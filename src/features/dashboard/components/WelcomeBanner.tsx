    ...
    >
      ...
      <div className="flex-1 relative z-10">
        ...
        <h2 className="font-serif text-[clamp(20px,2vw,24px)] font-bold text-ink mb-1 tracking-tight leading-tight">
          Mochi needs a <em className="text-caramel italic font-normal underline decoration-caramel/30 underline-offset-4">bath today!</em>
        </h2>
        <p className="text-sm text-muted font-light leading-relaxed max-w-sm">
          It's been 18 days since Mochi's last grooming session. Keep them fresh and fluffy!
        </p>
      </div>

      <div className="flex items-center gap-6 relative z-10">
        <div className="text-[52px] drop-shadow-sm select-none animate-floating">🛁</div>
